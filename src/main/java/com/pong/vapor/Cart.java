...
public class Cart extends javax.swing.JDialog {
    ...
    private void purchaseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_purchaseButtonActionPerformed
        ...
        if (!staticVar.userCart.isEmpty()) {
            ...
            if (staticVar.userThatIsLoggedIn.balance < totalCartPrice) {
                ...
                try {
                    ...
                    for (Game g : staticVar.userCart) {
                        ...
                        // updates balance in store and cart labels
                        userBalance.setText("$ " + String.format("%.2f", staticVar.userThatIsLoggedIn.balance));
                        Store.userBalance.setText("$ " + String.format("%.2f", staticVar.userThatIsLoggedIn.balance));
                        conn.close();
                        dispose();
                } catch (Exception e) {
                    e.printStackTrace();
            ...
            JOptionPane.showMessageDialog(null, "Cart is empty.", "Failed", JOptionPane.WARNING_MESSAGE);
        }
