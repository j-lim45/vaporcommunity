...
public class Store extends javax.swing.JFrame {
    ...
    static void storeResultQuery() {
        ...
        try {
            ...
            storeResults.clear();
            while (rs.next()) {
                storeResults.add(new Game(rs.getInt("game_id"), rs.getString("name"), rs.getString("description"), rs.getDouble("price"),rs.getString("release_date"), rs.getInt("developer_id"), rs.getInt("user_rating"), rs.getDouble("popularity")));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//            conn = DriverManager.getConnection("jdbc:sqlite:vapordb.db");
//            
//            return conn.createStatement().executeQuery("SELECT * FROM games ORDER BY popularity DESC").getDouble("balance");
//            
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
...
//    }
    ...
    private void initComponents() {
        ...
        userBalance.setText("$" + Double.toString(MainMenu.userThatIsLoggedIn.balance));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(vaporMarketPlaceLabel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGap(32, 32, 32))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(searchField, javax.swing.GroupLayout.DEFAULT_SIZE, 44, Short.MAX_VALUE)
                            .addGroup(layout.createSequentialGroup()
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        int column = jTable1.columnAtPoint(pointClicked);
